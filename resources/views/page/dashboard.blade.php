                ...
                <main id="main-content" class="site-main-dashboard">
                    <div class="page-dashboard-wrap">
                        <div class="dashboard">
                            <div class="row ">
                                <div class="col-12">
                                    <h4 class="title-dashboard">Dashboard 2</h4>
                                </div>
                            </div>
                                ...
                                <div class="row tf-counter">
                                    <div class="col-12 col-sm-6 col-xl-6 col-xxl-3">
                                        <div class="db-card tf-counter">
                                            ...
                                            <div class="content-overview">
                                                ...
                                                <div class="d-flex">
                                                    <div class="listing-text number" data-to="431" data-speed="3000"
                                                         data-waypoint-active="yes">431</div><span> + </span>
                                                </div>
                                    ...
                                    <div class="col-12 col-sm-6 col-xl-6 col-xxl-3">
                                        <div class="db-card tf-counter">
                                            ...
                                            <div class="content-overview">
                                                <span>Pending</span>
                                                <div class="listing-text number" data-to="416" data-speed="3000"
                                                     data-waypoint-active="yes">416</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-xl-6 col-xxl-3">
                                        <div class="db-card tf-counter">
                                            ...
                                            <div class="content-overview">
                                                ...
                                                <div class="d-flex">
                                                    <div class="listing-text number" data-to="251" data-speed="3000"
                                                         data-waypoint-active="yes">251</div><span> + </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6 col-xl-6 col-xxl-3">
                                        <div class="db-card tf-counter">
                                            ...
                                            <div class="content-overview">
                                                <span>My Review</span>
                                                <div class="d-flex">
                                                    <div class="listing-text number" data-to="235" data-speed="3000"
                                                         data-waypoint-active="yes">235</div><span> + </span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="dashboard-middle">
                                <div class="row">
                                    <div class="dashboard-middle-left col-xxl-9 col-xl-12">
