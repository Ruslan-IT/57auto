...
@section('content')
    ...
    <div id="wrapper">
        <div id="page" class="clearfix">
            ...
            <div class="widget-map-contact-us">
                <div class="themesflat-container full">
                    <div class="map4">
                        <div id="map4"></div>
                    </div>
